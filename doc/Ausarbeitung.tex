...
Als Ergebnis haben wir eine Grafische Benutzeroberfläche über die ein Mietgesuch an die Prozess-Engine gesendet werden kann. Die Prozess-Engine verarbeitet die Anfrage und verlangt, wenn nötig, an einigen Stellen eine Genehmigung. Am Ende wird die Anfrage entweder genehmigt oder Abgelehnt. Eine genehmigte Anfrage enthält dann eine Fahrzeugklasse und einen Gesamtpreis. Diese Daten werden dann über die GUI an den Benutzer ausgegeben. 
