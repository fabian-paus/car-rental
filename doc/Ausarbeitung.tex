...
Im Laufe dieser Projektdokumentation werden die einzelnen Arbeitsschritte strukturiert und detailliert beschrieben. Der Quellcode und die Projektdokumentation können über ein öffentliches Git-Repository (\url{https://github.com/fabian-paus/car-rental}) auf GitHub.com eingesehen werden. 
...
\begin{description}
	...
	\item[Fahranfänger:] Ein Kunde ist ein Fahranfänger, wenn er jünger als ein bestimmtes Alter ist oder
		...
		Geschäftsregel.	
	\item[Filialleiter:] Gewisse Entscheidungen beim Vermietungsprozess bedürfen der Genehmigung durch
		den Filialleiter.
...
durch Fahranfänger gemietet werden dürfen.
...
\begin{description}
	...
	\item[Prozessregel:] Beschreibt das Vorgehen im Geschäftsprozess (z.~B. Genehmigung durch Filialleiter)
...
Die Umsetzung des Prototyps haben wir in sechs Schritte eingeteilt:
\begin{enumerate}
...
Anwendungssituationen aus der Aufgabenstellung schreiben. Diese haben wir mithilfe von JUnit erstellt. Dabei ist uns aufgefallen,
dass bei sequenzieller Abarbeitung der Kunden A bis G die Wagen der Mittel- und
...
Wurde die Anfrage angenommen, werden in einem abschließenden Dialog die Fahrzeugklasse und die zu zahlenden Kosten angezeigt  (s. Abb. \ref{fig:ergebnis}).
